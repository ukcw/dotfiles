...
-- can set local config using the object below
local config = {};
return {
  ...
  -- Colors
  color_scheme                 = "ayu", -- full list @ wezfurlong.org/wezterm/colorschemes/index.html
  ...
  keys                         = {
    { key = 'x', mods = "CTRL | SHIFT | ALT", action = wezterm.action.CloseCurrentPane { confirm = true } }
  }
}
